...
<nav className="bg-white dark:bg-slate-900 font-manrope text-sm font-medium h-screen w-64 border-r border-slate-200 dark:border-slate-800 border-r fixed left-0 top-0 flex flex-col py-4 z-40">
{/*  Header  */}
...
<span className="material-symbols-outlined icon-fill text-lg">local_hospital</span>
</div>
<div>
...
{/*  Footer Navigation  */}
<div className="mt-auto px-2 flex flex-col gap-1 border-t border-slate-200 dark:border-slate-800 pt-4">
<a className="flex items-center gap-3 px-4 py-3 text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-blue-600 dark:hover:text-blue-400 transition-all cursor-pointer active:scale-95 transition-transform rounded-lg" href="#">
...
<div className="hidden md:flex items-center bg-slate-100 dark:bg-slate-800 rounded-full px-4 py-1.5 ml-4 focus-within:ring-2 focus-within:ring-blue-500 transition-shadow">
<span className="material-symbols-outlined text-slate-400 text-sm">search</span>
<input className="bg-transparent border-none focus:ring-0 text-sm text-slate-700 dark:text-slate-200 ml-2 w-48 placeholder-slate-400 font-body-sm py-1" placeholder="Search records, bills..." type="text" />
</div>
</div>
<div className="flex items-center gap-2">
{/*  Trailing Icons  */}
<button className="p-2 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors rounded-full active:opacity-80 transition-opacity relative">
<span className="material-symbols-outlined">notifications</span>
<span className="absolute top-2 right-2 w-2 h-2 bg-red-500 rounded-full border border-white"></span>
</button>
<button className="p-2 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors rounded-full active:opacity-80 transition-opacity">
<span className="material-symbols-outlined">help_outline</span>
</button>
{/*  Profile Image  */}
<div className="w-8 h-8 rounded-full bg-slate-200 overflow-hidden ml-4 border border-slate-200 cursor-pointer hover:ring-2 hover:ring-blue-500 hover:ring-offset-2 transition-all">
<img alt="Patient Profile Avatar" className="w-full h-full object-cover" data-alt="A professional, well-lit studio portrait of a confident young woman with clear skin and natural makeup. She is smiling softly, facing forward. The background is a clean, neutral studio gray that aligns perfectly with a modern, high-end light-mode UI aesthetic." src="https://lh3.googleusercontent.com/aida-public/AB6AXuD5w_p0H8pCOBVz_2BJQrr1ESz3XyQO9JQjDKvEDghYJVyjZnZqFbpqVZMW95XOxohIUVHMopKmEmwkJqoNyXOHa09DX9u3lOZyT0Rf__SL-QT_sqL57UPOC41J-lrs_6nAAHvie1GItDgezUsX6NxQ3NHvZ5LzKJpOBv49x4WwZB09e8J32MPcOHD_CzxRLNzA-a-f0ocsBFKtZAG-EDGmuu6Z2oaUhYQITGKNDmKxPTGvbtOsz3uL0c6HF3eqe6gKCtVutYXIDbXr" />
</div>
</div>
</header>
{/*  Page Content Canvas  */}
...
<button className="bg-primary hover:bg-primary-fixed-dim text-on-primary font-label-md text-label-md py-2 px-6 rounded-lg transition-colors shadow-sm">
                                        Pay Now
                                    </button>
</div>
</div>
...
<button className="w-full bg-white text-primary hover:bg-surface-container-lowest font-label-md text-label-md py-3 px-4 rounded-lg transition-colors text-center shadow-sm">
                                    Pay Full Balance
                                </button>
<button className="w-full bg-transparent border border-primary-fixed text-primary-fixed hover:bg-primary-fixed/10 font-label-md text-label-md py-3 px-4 rounded-lg transition-colors text-center">
                                    Set Up Payment Plan
                                </button>
</div>
</div>
...
<span className="material-symbols-outlined text-[16px] text-on-secondary-container icon-fill">check</span>
</div>
<div>
...
{/*  Full Width Bottom Column (Span 12)  */}
